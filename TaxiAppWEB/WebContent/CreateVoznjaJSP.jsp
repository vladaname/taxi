...
<title>Lista slobodnih voznji</title>
<meta charset="utf-8">
	...
	<div class="container">
		<div class="row col-md-12 custyle">
			<table class="table table-striped custab">
				...
				<tbody>
					<c:forEach var="slobodneVoznje" items="${ListaSlobodnihVoznji }">
						<tr>
							<td>${slobodneVoznje.idVoznja }</td>
							<td>${slobodneVoznje.ime }</td>
							<td>${slobodneVoznje.prezime }</td>
							<td>
								<form action="/TaxiAppWEB/SlobodneVoznje" method="post">
									<input type="hidden" name="idVoznja"
										value="${slobodneVoznje.idVoznja }" />
